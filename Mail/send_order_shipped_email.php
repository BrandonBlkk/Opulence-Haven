...
if (isset($_GET['id'])) {
    ...
    $query = "
        SELECT o.OrderID, o.ShippingAddress, o.City, o.State, o.TotalPrice, u.UserEmail, u.UserName
        FROM ordertb o
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $totalPrice = number_format((float)$order['TotalPrice'], 2);
        ...
        try {
            ...
            // Email Content
            $mail->isHTML(true);
            $mail->Subject = "Your Order #{$orderId} has been Shipped!";
            $mail->Body = '
            <html>
            <head>
                <meta charset="UTF-8">
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Your order <strong>#' . htmlspecialchars($orderId) . '</strong> has been shipped!</p>
                        <p><strong>Shipping Address:</strong><br>' . htmlspecialchars($shippingAddress) . ", " . htmlspecialchars($city) . ", " . htmlspecialchars($state) . '</p>
                        <p><strong>Total Paid:</strong> $' . $totalPrice . '</p>
                        <p>You will receive your package soon. Thank you for shopping with <strong>Opulence Haven</strong>.</p>

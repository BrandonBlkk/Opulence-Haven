            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
                ...
                ?>
                    <div class="flex gap-10">
                        <div>
                            <i class="ri-archive-line text-2xl text-amber-500 select-none"></i>
                            <h1 class="font-semibold">FLEXIBLE CANCELLATION</h1>
                            <p class="text-sm">Free cancellation up to 24 hours before check-in.</p>
                        </div>
                        <div>
                            <i class="ri-wifi-line text-2xl text-amber-500 select-none"></i>
                            <h1 class="font-semibold">FREE AMENITIES</h1>
                            <p class="text-sm">Complimentary WiFi and breakfast included.</p>
                        </div>
                    </div>
                <?php
                }

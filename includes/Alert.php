...
<div id="alertBox" class="fixed -bottom-full right-3 items-center bg-white rounded-md shadow-lg border z-40 p-3 transition-all duration-500 <?php echo $emailExists ? 'border-red-300' : 'border-green-300'; ?>">

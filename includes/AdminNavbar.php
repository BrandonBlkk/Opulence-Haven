    ...
    <div>
        ...
        <div class="divide-y-2 divide-slate-100">
            ...
            <div class="flex flex-col pt-2">
                ...
                <a href="RoleManagement.php" class="flex items-center gap-4 p-2 rounded-sm text-slate-600 hover:bg-slate-100 transition-colors duration-300 select-none">
                    ...
                    <div
                        ...
                        <div class="pl-3">
                            <a href="../Admin/AddSupplier.php" class="flex justify-between text-slate-600 hover:bg-gray-100 p-2 rounded-sm transition-colors duration-300 select-none">
                                ...
                                <p class="px-1 text-white bg-blue-950 rounded-sm ml-5"><?php echo $supplierCount ?></p>
                            </a>

...
// Process Cart Items (now using ordertb with status 'Order Placed')
$cartQuery = "SELECT 
                od.*, 
                p.Title, 
                p.Price, 
              ...
              WHERE o.UserID = ? AND o.Status = 'Order Placed'";
...
// $reservationQuery = "SELECT * FROM reservationtb WHERE UserID = ? AND Status = 'Order Placed' ORDER BY ReservationDate DESC LIMIT 1";
